...
export const environment = {
  production: false,
  supremeServiceApiUrl:
    "https://supreme_dev.simplifymvt.com/api/supremeService/",
  facilitatorAdminServiceApiUrl:
    "https://user_dev.simplifymvt.com/api/userService/facilitator/admin/",
  facilitatorInternalUserServiceApiUrl:
    "https://user_dev.simplifymvt.com/api/userService/facilitator/internalUser/",
  hospitalAdminServiceApiUrl:
    "https://user_dev.simplifymvt.com/api/userService/hospital/admin/",
  hospitalInternalUserServiceApiUrl:
    "https://user_dev.simplifymvt.com/api/userService/hospital/internalUser/",
  sharedServiceApiUrl:
    "https://user_dev.simplifymvt.com/api/userService/shared/",
  cmsApiUrl: "https://cms.simplifymvt.com/api/",
  secretKeyCrypto: "Sai$$@jkCjle90$@m$$pina943SaiCgjekBjeio$&&y73980@@Ssdsd==",
  socketUrl: "https://supreme_dev.simplifymvt.com/",
