...
@Component({
  selector: "app-shared-query-management-toolbar",
  templateUrl: "./query-management-toolbar.component.html",
  styleUrls: ["./query-management-toolbar.component.scss"],
})
export class QueryManagementToolbarComponent implements OnInit {
  timeout = null;
