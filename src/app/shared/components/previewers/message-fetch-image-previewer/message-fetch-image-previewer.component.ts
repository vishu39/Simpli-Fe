...
@Component({
  selector: "app-message-fetch-image-previewer",
  templateUrl: "./message-fetch-image-previewer.component.html",
  styleUrls: ["./message-fetch-image-previewer.component.scss"],
})
export class MessageFetchImagePreviewerComponent implements OnInit {
  @Input() fileList: any = [];
