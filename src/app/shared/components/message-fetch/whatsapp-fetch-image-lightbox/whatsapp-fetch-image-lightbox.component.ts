...
@Component({
  selector: "shared-whatsapp-fetch-image-lightbox",
  templateUrl: "./whatsapp-fetch-image-lightbox.component.html",
  styleUrls: ["./whatsapp-fetch-image-lightbox.component.scss"],
})
export class WhatsappFetchImageLightboxComponent implements OnInit {
  ...
  getSource() {
    ...
    if (this.dataArray[this.index]?.type === "application/pdf") {
      ...
      }#zoom=500%&view=FitH&toolbar=0&navpanes=0`;
    } else {
      return this.dataArray[this.index].url;
    }
  }
