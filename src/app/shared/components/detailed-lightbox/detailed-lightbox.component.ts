...
@Component({
  selector: "app-detailed-lightbox",
  templateUrl: "./detailed-lightbox.component.html",
  styleUrls: ["./detailed-lightbox.component.scss"],
})
export class DetailedLightboxComponent implements OnInit {
