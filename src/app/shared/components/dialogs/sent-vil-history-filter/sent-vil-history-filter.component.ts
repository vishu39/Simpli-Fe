...
@Component({
  selector: "app-sent-vil-history-filter",
  templateUrl: "./sent-vil-history-filter.component.html",
  styleUrls: ["./sent-vil-history-filter.component.scss"],
})
export class SentVilHistoryFilterComponent implements OnInit {
  dialogTitle: string;
  ...
  constructor(
    public dialogRef: MatDialogRef<SentVilHistoryFilterComponent>,
  ...
  editFilter() {
    ...
    if (!!hospital || !!country || !!treatment ||   userName?.length > 0 || !!userType) {
