...
export class FacilitatorService {
  serviceApiUrl: string =
    ...
    getUserType() === "admin"
      ? environment.facilitatorAdminServiceApiUrl
      : environment.facilitatorInternalUserServiceApiUrl;
  constructor(
    private http: HttpClient,
    private router: Router,
    private sharedService: SharedService
  ) {
    this.sharedService.facilitatorLoginSubject.subscribe((res) => {
      if (res === "admin") {
        this.serviceApiUrl = environment.facilitatorAdminServiceApiUrl;
      } else if (res === "member") {
        this.serviceApiUrl = environment.facilitatorInternalUserServiceApiUrl;
      }
    });
  }
  ...
  getEmailContentModule(data: any) {
    return this.http
      .get(
        this.serviceApiUrl +
          `getEmailContentModule?isEmailSendSetting=${data?.isEmailSendSetting}`
      )
      .pipe(
        map((res: any) => {
          res.data = this.sharedService.decrypt(res.data);
  ...
  // doctor link
  assignOpinionRequestToDoctorOpenLink(payload: any) {
    const loginLinkToken = localStorage.getItem("loginLinkToken");
    const headers = new HttpHeaders().set("login_link_token", loginLinkToken);
    const dataEncrypt = this.sharedService.encrypt(payload);
    return this.http.post(
      `${environment.facilitatorAdminServiceApiUrl}assignOpinionRequestToDoctorOpenLink`,
      { dataEncrypt },
      { headers }
    );
  }
  ...
  getDoctorOpinionRequestByDoctorOpenLink() {
    ...
    return this.http
      .get(
        `${environment.facilitatorAdminServiceApiUrl}getDoctorOpinionRequestByDoctorOpenLink`,
        {
          headers,
        }
      )
  ...
  opinionReceivedDoctorOpenLink(payload: any) {
    const loginLinkToken = localStorage.getItem("loginLinkToken");
    const headers = new HttpHeaders().set("login_link_token", loginLinkToken);
    const dataEncrypt = this.sharedService.encrypt(payload);
    return this.http.post(
      `${environment.facilitatorAdminServiceApiUrl}opinionReceivedDoctorOpenLink`,
      { dataEncrypt },
      { headers }
    );
  }
  ...
  getDoctorOpinionReceivedByHospitalOpenLink() {
    ...
    return this.http
      .get(
        `${environment.facilitatorAdminServiceApiUrl}getDoctorOpinionReceivedByHospitalOpenLink`,
        {
          headers,
        }
      )
  ...
  getAllEmployeeUserFacilitator(params: any) {
    return this.http
      .get(this.serviceApiUrl + `getInternalUserByUserType`, {
        params: { ...params },
      })
  ...
  getMessageContentModule(data: any) {
    return this.http
      .get(
        this.serviceApiUrl +
          `getMessageContentModule?isMessageSendSetting=${data?.isMessageSendSetting}`
      )
      .pipe(
        map((res: any) => {
          res.data = this.sharedService.decrypt(res.data);
  ...
  getDefaultMessage(id: string) {
    return this.http.get(this.serviceApiUrl + `getDefaultMessage/${id}`).pipe(
      map((res: any) => {
        res.data = this.sharedService.decrypt(res.data);
        return res;
      })
  ...
  addDefaultMessage(data: any) {
    const dataEncrypt = this.sharedService.encrypt(data);
    return this.http.post(this.serviceApiUrl + `addDefaultMessage`, {
      dataEncrypt,
    });
  }

  getSupremeDefaultMessage(id: string) {
    return this.http
      .get(this.serviceApiUrl + `getSupremeDefaultMessage/${id}`)
      .pipe(
        map((res: any) => {
          res.data = this.sharedService.decrypt(res.data);
          return res;
