...
import { AddReferralPartnerStaffComponent } from "./dialog/add-referral-partner-staff/add-referral-partner-staff.component";
...
@Component({
  selector: "app-referral-partner-staff",
  templateUrl: "./referral-partner-staff.component.html",
  styleUrls: ["./referral-partner-staff.component.scss"],
})
export class ReferralPartnerStaffComponent implements OnInit {
  ...
  addHospitalStaff(heading: string) {
    const dialogRef = this.dialog.open(AddReferralPartnerStaffComponent, {
      width: "100%",
      disableClose: true,
      autoFocus: false,
    });
