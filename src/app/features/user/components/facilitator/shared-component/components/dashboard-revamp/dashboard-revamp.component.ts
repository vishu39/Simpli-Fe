...
export class DashboardRevampComponent implements OnInit {
  ...
  createChartForMap(data = []) {
    ...
    // polygonSeries.include = data.map(item => item.id);
    // Template settings
  ...
  getQueryCountForTopCards(filter_obj: any) {
    ...
    this.facilitatorService.getQueryCountForTopCards(filter_obj).subscribe({
      next: (res: any) => {
  ...
  getOpinionCountForTopCards(filter_obj: any) {
    ...
    // Call the API
    this.facilitatorService.getOpinionCountForTopCards(filter_obj).subscribe({
      next: (res: any) => {
  ...
  getVilCountForTopCards(filter_obj: any) {
    ...
    this.facilitatorService.getVilCountForTopCards(filter_obj).subscribe({
      next: (res: any) => {
  ...
  getOnGroundCountForTopCards(filter_obj: any) {
    ...
    this.facilitatorService.getOnGroundCountForTopCards(filter_obj).subscribe({
      next: (res: any) => {
  ...
  getVilTatCountForTopCards(filter_obj: any) {
    ...
    this.facilitatorService.getVilTatCountForTopCards(filter_obj).subscribe({
      next: (res: any) => {
  ...
  getQueryBarChartData(filter_obj: any) {
    ...
    this.facilitatorService.getQueryBarChartData(filter_obj).subscribe(
      (res: any) => {
  ...
  getOpinionBarChartData(filter_obj: any) {
    ...
    this.facilitatorService.getOpinionBarChartData(filter_obj).subscribe(
      (res: any) => {
  ...
  getVilBarChartData(filter_obj: any) {
    ...
    this.facilitatorService.getVilBarChartData(filter_obj).subscribe(
      (res: any) => {
  ...
  getConfirmationBarChartData(filter_obj: any) {
    ...
    this.facilitatorService.getConfirmationBarChartData(filter_obj).subscribe(
      (res: any) => {
  ...
  getTotalMultiLineChartData(filter_obj: any) {
    ...
    this.facilitatorService.getTotalMultiLineChartData(filter_obj).subscribe(
      (res: any) => {
  ...
  getPatientByStatusBarChart(filter_obj: any) {
    ...
    this.facilitatorService.getPatientByStatusBarChart(filter_obj).subscribe(
      (res: any) => {
        ...
        this.patientByStatusMainSeriesData = [
          {
            ...
            data: [opinionReceivedCount, 0, 0, 0, 0],
          },
          {
          ...
          { name: "OPD Received", data: [0, opdReceivedCount, 0, 0, 0] },
          { name: "OPD Requested", data: [0, opdRequestedCount, 0, 0, 0] },

          {
            name: "Proforma Received",
          ...
          { name: "VIL Received", data: [0, 0, 0, vilReceivedCount, 0] },
  ...
  getCountryPieChartData(filter_obj: any) {
    ...
    this.facilitatorService.getCountryPieChartData(filter_obj).subscribe(
      (res: any) => {
  ...
  getCountryMapData(filter_obj: any) {
    ...
    // this.facilitatorService.getCountryMapData(filter_obj).subscribe(
    //   (res: any) => {
  ...
  getAllSelectedFilter() {
    ...
    this.facilitatorService.getAllSelectedFilter().subscribe(
      (res: any) => {
  ...
  changeDefaultFilterFromSelectedData(data: any) {
    ...
    if (data?.referralPartner?.length) {
      this.selectedOwnReferralPartnerSearch = data?.referralPartner;
      this.filterSelectionForm.patchValue({
    ...
    if (this.selectedOwnReferralPartnerSearch?.length) {
      filter_obj["referralPartner"] = this.selectedOwnReferralPartnerSearch;
    }
  ...
  selectAllOwnReferralPartner(event) {
    if (event.checked) {
      ...
      this.ownReferralPartnerData?.forEach((data: any) => {
        this.selectedOwnReferralPartnerSearch.push({
          _id: data?._id,
          name: data?.name,
        });
      });
