...
@Component({
  selector: "app-referral-default-message",
  templateUrl: "./referral-default-message.component.html",
  styleUrls: ["./referral-default-message.component.scss"],
})
export class ReferralDefaultMessageComponent implements OnInit {
