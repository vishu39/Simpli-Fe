...
@Component({
  selector: "app-add-own-referral-partner-zone",
  templateUrl: "./add-own-referral-partner-zone.component.html",
  styleUrls: ["./add-own-referral-partner-zone.component.scss"],
})
export class AddOwnReferralPartnerZoneComponent implements OnInit {
  zoneForm: FormGroup;
  zoneData: any;
  referralId: string;
  dialogTitle: string;
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<AddOwnReferralPartnerZoneComponent>
  ) {
    this.buildForm();
  }
  ngOnInit(): void {
