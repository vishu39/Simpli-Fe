...
export class FinanceListComponent implements OnInit {
  ...
  getQuerryData() {
    ...
    this.facilitatorService.getFinanceQueryList(this.searchParams).subscribe(
      (res: any) => {
  ...
  downloadQuery() {
    ...
    this.facilitatorService.downloadFinanceQuery().subscribe((res: any) => {
      let e = res?.data;
