...
export class MessageContentComponent implements OnInit {
  ...
  getAllDefaultMessageContent() {
    ...
    this.facilitatorService.getAllDefaultMessageContent().subscribe(
      (res: any) => {
        ...
        this.facilitatorService.getAllMessageContent().subscribe((res: any) => {
    ...
    this.svc.ui
      ...
      .subscribe((res) => {
        if (res.button.name === "YES") {
          this.facilitatorService.deleteMessageContent(id).subscribe((res: any) => {
