...
export class DefaultEmailComponent implements OnInit {
  ...
  ngOnChanges(changes: SimpleChanges) {
    if (!!changes.hospitalId.currentValue) {
      ...
      // this.defaultEmailForm.controls["confirmationTo"].enable();
      // this.defaultEmailForm.controls["confirmationCc"].enable();
    }
  }
  ...
  changeDefaultSettingFacilitator(event: Boolean) {
    ...
    this.facilitatorService
      .addDefaultEmail(newDefaultData)
      .subscribe((res: any) => {
  ...
  getSupremeDefaultEmail() {
    this.facilitatorService
      .getSupremeDefaultEmail(this.hospitalId)
      .subscribe((res: any) => {
    ...
    if (this.hospitalId) {
      if (this.defaultEmailForm.valid) {
        ...
        if (this.defaultEmailData?.defaultSetting) {
          this.defaultEmailForm.value.defaultSetting = true;
        } else {
          this.defaultEmailForm.value.defaultSetting = false;
        }
