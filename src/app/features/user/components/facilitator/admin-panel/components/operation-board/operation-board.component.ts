...
export class OperationBoardComponent implements OnInit {
  ...
  items = ['Carrots', 'Tomatoes', 'Onions', 'Apples', 'Avocados','Carrots', 'Tomatoes', 'Onions', 'Apples', 'Avocados'];
  ...
  dialog(item: any,title:string){
    ...
    this.svc.dialog.open(OperationDialogComponent,{data:dialogData,height:'90vh',width:'100vw',disableClose:true})
  }
}
