...
@Component({
  selector: "app-own-referral-default-email",
  templateUrl: "./own-referral-default-email.component.html",
  styleUrls: ["./own-referral-default-email.component.scss"],
})
export class OwnReferralDefaultEmailComponent implements OnInit {
