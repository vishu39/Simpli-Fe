...
@Component({
  selector: "app-message-fetch-assign-opinion",
  templateUrl: "./message-fetch-assign-opinion.component.html",
  styleUrls: ["./message-fetch-assign-opinion.component.scss"],
})
export class MessageFetchAssignOpinionComponent implements OnInit {
  ...
  getAllOpinionRequest() {
    this.hospitalService
      .getAllOpinionRequest(this.emailFetchData?._id)
      .subscribe((res: any) => {
