...
export class RecordOpinionComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.buildForm();
    this.getAllOpinionRequestByDoctor();
  }
  ...
  getAllOpinionRequestByDoctor() {
    this.hospitalService
      .getAllOpinionRequestByDoctor(this.patientData?._id)
      .subscribe((res: any) => {
