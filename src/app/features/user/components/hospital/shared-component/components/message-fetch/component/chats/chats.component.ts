...
export class ChatsComponent implements OnInit {
  ...
  getMessageFetch() {
    this.hospitalService.getMessageFetch().subscribe((res: any) => {
      if (!res.isError) {
  ...
  //   "Please wait, loading the chat..."
  // "Loading... Please wait before selecting another chat."
  // "Hold on! We're loading the chat for you."
  // "Chat is loading, please wait a moment."
  // "Slow down! Let the current chat load first."
  // "Fetching chat data... Please wait."
