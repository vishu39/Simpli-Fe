...
export class MessageFetchActionComponent implements OnInit {
  ...
  // getRemoteFileStreams() {
  //   this.isBufferLoading = true;
  //   this.sharedService
  //     .getRemoteFileStreams({ media: this.mediaArray })
  //     .subscribe(
  //       (res: any) => {
  //         this.mediaBufferData = res?.data;
  //         this.convertBufferIntoImageFile(this.mediaBufferData);
  //         this.isBufferLoading = false;
  //       },
  //       () => {
  //         this.mediaBufferData = [];
  //         this.isBufferLoading = false;
  //       }
  //     );
  // }

  // convertBufferIntoImageFile(bufferArray: any) {
  //   bufferArray?.forEach((ba: any) => {
  //     let file = convertBufferToFile(
  //       ba?.buffer?.data,
  //       ba?.filename,
  //       ba?.mimetype
  //     );
