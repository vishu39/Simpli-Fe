...
@Component({
  selector: "app-sm-lightbox",
  templateUrl: "./sm-lightbox.component.html",
  styleUrls: ["./sm-lightbox.component.scss"],
})
export class SmLightboxComponent implements OnInit, OnChanges {
